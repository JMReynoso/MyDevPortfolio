...
export function WarmButton({ 
  ...
  const baseStyles = 'rounded-2xl transition-colors font-semibold inline-flex items-center justify-center';
  
  const variantStyles = {
    primary: 'bg-[#7BA05B] text-white hover:bg-[#4A6741] shadow-lg',
    secondary: 'bg-white text-[#2C2416] hover:bg-[#F5E6D3] border-2 border-[#8B6F47]/20',
    outline: 'bg-transparent text-[#7BA05B] hover:bg-[#7BA05B]/10 border-2 border-[#7BA05B]'
  };
